...
let timerDiv, titleDiv, titleHeading, titleImage
...
function setup() {
  ...
  //vi laver en div til at indeholde forsiden 
  titleDiv = createDiv().class('title')
  //vi laver en overskrift
  titleHeading = createDiv('Run Forest Run')
  //vi laver en element med et forsidebillede
  titleImage = createImg('./assets/title.png')

  titleDiv.child(titleHeading)
  titleDiv.child(titleImage)
...
function startGame(){
  ...
  //vi begynder meed at tønde alle m5'ere
  client.publish('m5/all', 'on')
}
